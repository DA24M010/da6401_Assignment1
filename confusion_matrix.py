...
model = FeedforwardNN(num_layers=3, hidden_size=64, learning_rate=0.001,
                        activation='tanh', optimizer='nadam', weight_init='random', weight_decay=0)

model.train(epochs=10, batch_size=32, dataset = "fashion_mnist", wandb_logs= True, log_test= True)